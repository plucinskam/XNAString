...
/**
 *  @file     ViennaRNA/io/file_formats.h
 ...
 *                  this function
 */
DEPRECATED(void vrna_extract_record_rest_constraint(char          **cstruc,
                                                    const char    **lines,
                                                    unsigned int  option),
...
DEPRECATED(unsigned int get_multi_input_line(char         **string,
                                             unsigned int options),
           "This function is obsolete");
