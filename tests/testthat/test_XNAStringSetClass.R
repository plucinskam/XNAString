testthat::test_that(
  desc = "checks if XNAStringSet object creation works",
  code = {
    my_dic <-
    ...
    testthat::expect_error(
      XNAStringSet(
        objects = list(obj1, obj2, obj3, obj4, obj5)
      ), NA
    )
...
testthat::test_that(
  desc = "check set2Dt function when base DNAString",
  code = {
    my_dic <-
      data.table::data.table(
        type = c(
...
testthat::test_that(
  desc = "checks if creation of XNAStringSet from data.table 
                    (or data.frame) works",
  code = {
...
testthat::test_that(
  desc = "checks if validation while creating XNAStringSet 
...
testthat::test_that(
  desc = "check XNAString2XNAStringSet function",
  code = {
    obj1 <-
      XNAString(
        name = "a",
