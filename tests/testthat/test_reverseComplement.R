...
testthat::test_that("Reverse complement works correctly (1)", {
  obj1 <- XNAString::XNAString(base = "ACAGETE",
                    sugar = 'FODDDDD',
                    conjugate3 = 'TAG')
