testthat::test_that(
  desc = "checks if XNAString object creation works",
  code = {
...
testthat::test_that(
  desc = "checks if XNAString object creation with
  ...
  code = {
    ...
    obj <-
      XNAStringFromHelm(
        helm = "CHEM1{[5gn2c6]}|RNA1{P.[dR](C)P.[dR](A)P.[LR](G)[sP].[LR](A)[sP].[LR](G)[sP].[LR](A)[sP].[dR](A)[sP].[dR](G)[sP].[dR](G)[sP].[dR](C)[sP].[dR](A)[sP].[dR](C)[sP].[dR](A)[sP].[dR](G)[sP].[dR](A)[sP].[LR]([5meC])[sP].[LR](G)[sP].[LR](G)}$CHEM1,RNA1,1:R2-1:R1$$$V2.0",
        remove_linker = FALSE
      )
...
testthat::test_that(
  desc = "checks if making complementarity dictionary
                    optional works",
  code = {
    compl_dict <- data.table::data.table(
      base = c("A", "J", "K"),
      target = c("A", "B", "C"),
